...
func main() {
    log.Println("Start the process ")
	client := &http.Client{
		Transport: &http.Transport{},
	}

    log.Println("fetch a new random article from the wikipedia")
